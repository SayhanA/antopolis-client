    ...
    <footer className="bg-red-800 text-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/80 text-sm">Subscribe our newsletter and get discount 25%off</p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
              ...
              <p className="text-white/90 text-sm">3517 W. Gray St. Utica, Pennsylvania 57867</p>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <p className="text-white/90 text-sm">Sun - Sat / 10:00 AM - 8:00 PM</p>
            </div>
          </div>
      ...
      <div className="bg-red-900 py-4">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/90 text-sm">Copyright © 2025. All rights reserved</p>
